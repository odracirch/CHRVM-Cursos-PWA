...
export default function Page() {
  ...
  async function loadData() {
    ...
    console.log('DEBUG USUARIO AUTENTICADO:', userData.user?.id, userError)

    if (!userData.user) {
      setError('DEBUG: NO HAY USUARIO AUTENTICADO EN SUPABASE.')
      setLoading(false)
      return
    }
  ...
  return (
    <AuthGuard roles={['instructor', 'admin']}>
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="mb-5">
          <a
              href={`/instructor/cursos/${String(params.id)}/evaluaciones`}
